...
class EmployerCreateTabletTest extends TestCase
{
    /** @test */
    public function employer_see_correct_form_for_managing_tablets()
    {
    ...
    /** @test */
    public function employer_can_store_data_for_tablet()
    {
        $this->withoutExceptionHandling();
