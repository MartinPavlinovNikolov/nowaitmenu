...
class PostTotalTest extends TestCase
{
    /** @test */
    ...
    /** @test */
    public function employee_can_send_valid_data_for_order_when_hit_the_total()
    {
        $this->withoutExceptionHandling();
    ...
    /** @test */
    public function total_can_be_stored_correctly_in_database()
    {
        $this->withoutExceptionHandling();
